    ...
    public static class WifiInfo {
        ...
        public String toString() {
            return "WifiInfo{" +
                    ...
                    ", wifi_networkId='" + wifi_networkId + '\'' +
                    ", wifi_hiddenSSID='" + wifi_hiddenSSID + '\'' +
                    ", wifi_frequency='" + wifi_frequency + '\'' +
                    ", wifi_passpointFqdn='" + wifi_passpointFqdn + '\'' +
                    ", wifi_passpointProviderFriendlyName='" + wifi_passpointProviderFriendlyName + '\'' +
                    ", wifi_rxLinkSpeedMbps='" + wifi_rxLinkSpeedMbps + '\'' +
                    ", wifi_txLinkSpeedMbps='" + wifi_txLinkSpeedMbps + '\'' +
                    ", wifi_maxSupportedRxLinkSpeedMbps='" + wifi_maxSupportedRxLinkSpeedMbps + '\'' +
                    ", wifi_maxSupportedTxLinkSpeedMbps='" + wifi_maxSupportedTxLinkSpeedMbps + '\'' +
                    ", wifi_wifiStandard='" + wifi_wifiStandard + '\'' +
                    ", wifi_currentSecurityType='" + wifi_currentSecurityType + '\'' +
                    ", wifi_subscriptionId='" + wifi_subscriptionId + '\'' +
                    ", wifi_ScanResultLength='" + wifi_ScanResultLength + '\'' +
                    ", wifi_ScanResultInfo='" + wifi_ScanResultInfo + '\'' +
                    '}';
        }
